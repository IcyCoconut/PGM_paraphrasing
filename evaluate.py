...
from utils import get_corpus_bleu_scores, savetexts, appendtext
...
def main():
    ...
    parser.add_argument('--reference_path', default="data/testdata/reference.txt", type=str)
    parser.add_argument('--generated_path', default="data/testdata/result.txt", type=str)
    parser.add_argument('--input_path', default="data/testdata/c_origin.txt", type=str)
...
def evaluate_bleu_corpus(reference_path, generated_path):
    ...
    print('bleu_corpus scores:', sumss, bleu_scores)
...
def evaluate_bleu2(reference_path, generated_path):
    ...
    bleu_scores = [nltk.translate.bleu_score.sentence_bleu(a,g,weights=[0.5,0.5,0,0],
        smoothing_function=nltk.translate.bleu_score.SmoothingFunction().method1) for a,g in zip(\
                actual_word_lists, generated_word_lists) ]
    print('sentence level bleu2', np.mean(bleu_scores))
...
def evaluate_semantic(reference_path, generated_path):
    ...
    print("semantic", torch.mean(summation))
